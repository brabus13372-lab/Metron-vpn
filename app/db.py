...
class Database:
    ...
    async def init_schema(self) -> None:
        ...
        async with self.transaction() as conn:
            ...
            await conn.execute(create_support_indexes)
    ...
    async def create_ticket(
        ...
        files — список {'name': str, 'size': int, 'type': str} (только метаданные, не бинарь).
...
async def create_ticket(
    ...
    return await get_db().create_ticket(user_id, message, files)

async def get_user_tickets(
    user_id: int,
    limit: int = 20,
) -> List[Dict[str, Any]]:
    return await get_db().get_user_tickets(user_id, limit)
